...
function init() {
  ...
  function gameOver() {
    ...
    if(score)
      ...
      tweet.href='http://twitter.com/share?url=http://is.gd/PnFFzu&text=I just scored ' +score+ ' points in the Paltform doodle jump game! can you do better? https://paltform.fr/test/doodlejump/doodlejump.html';
    
      var facebook = document.getElementById("fbBtn");
      facebook.href='https://paltform.fr/soon.html';
...
function showGoMenu() {
  ...
  scoreText.innerHTML = "You scored " + score + " points!";
    if(score > 20000) {
      scoreText.innerHTML = "You scored " + score + " points! \n if i didn't see this, you're cheating!";
    };
}
